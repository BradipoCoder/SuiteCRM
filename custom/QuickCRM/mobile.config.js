...
Beans['Accounts'].AdditionalFields = ['phone_office','phone_fax','website','email1','description','vat_number_c','codice_fiscale_c','$ADDbilling','$ADDshipping','imp_agent_code_c','industry','imp_status_c','imp_status_phase__c','imp_profitability_c','credit_risk_c','imp_client_yearly_revenue_c','imp_interest_articles_c','employee_number_c','imp_competitor_c','imp_other_competitor_c','imp_sync_as_client_c','imp_sync_as_supplier_c','imp_macchine_c','imp_macchine_proprieta_c','imp_macchine_note_c','imp_metodo_notes_c'];
Beans['Accounts'].SearchFields = ['imp_agent_code_c','vat_number_c','industry','imp_status_c','imp_status_phase__c','ft_anno_meno_uno_completo_c','zone_c'];
Beans['Accounts'].CustomListFields = ['billing_address_city','industry','imp_status_c','imp_status_phase__c'];
