...
QCRM.enableBeans(['Accounts', 'Contacts', 'Tasks', 'Calls', 'Meetings', 'Opportunities', 'Notes', 'Documents', 'Project', 'ProjectTask', 'Cases', 'mkt_Worklogs', 'Emails', 'AOS_Products', 'AOS_Quotes', 'AOR_Reports', 'AOS_Product_Categories', 'mkt_Inspection_Washing']);
Beans['Accounts'].AdditionalFields = ['phone_office','phone_fax','website','email1','description','vat_number_c','codice_fiscale_c','$ADDbilling','$ADDshipping','imp_agent_code_c','industry','imp_status_c','imp_status_phase__c','imp_forced_status_c','ft_periodo_attuale_c','mesimobili12_c','dagenaoggi_c','ft_anno_meno_uno_completo_c','imp_profitability_c','credit_risk_c','imp_client_yearly_revenue_c','imp_interest_articles_c','employee_number_c','imp_competitor_c','imp_other_competitor_c','imp_ex_agent_code_c','imp_sync_as_client_c','imp_sync_as_supplier_c','imp_macchine_c','imp_macchine_proprieta_c','imp_metodo_notes_c','imp_macchine_note_c','imp_commercial_notes_c'];
Beans['Accounts'].SearchFields = ['imp_agent_code_c','imp_ex_agent_code_c','vat_number_c','imp_status_c','imp_status_phase__c','imp_forced_status_c','ft_periodo_attuale_c','mesimobili12_c','dagenaoggi_c','ft_anno_meno_uno_completo_c','zone_c','industry','billing_address_street','billing_address_city'];
Beans['Accounts'].CustomListFields = ['billing_address_city','billing_address_street','imp_status_phase__c','mesimobili12_c'];
Beans['Accounts'].CustomLinks = {
    ...
    'mkt_inspection_washing_accounts': {title: 'mkt_Inspection_Washing'},
    'accounts_contacts_imp_dir': {title: 'LBL_ACCOUNTS_CONTACTS_IMP_DIR_CONTACTS'},
    'accounts_contacts_imp_acq': {title: 'LBL_ACCOUNTS_CONTACTS_IMP_ACQ_CONTACTS'},
    'accounts_contacts_imp_adm': {title: 'LBL_ACCOUNTS_CONTACTS_IMP_ADM_CONTACTS'},
    'accounts_contacts_imp_com': {title: 'LBL_ACCOUNTS_CONTACTS_IMP_COM_CONTACTS'},
    'accounts_contacts_imp_opr': {title: 'LBL_ACCOUNTS_CONTACTS_IMP_OPR_CONTACTS'},
    'accounts_contacts_mekit_dir': {title: 'LBL_ACCOUNTS_CONTACTS_MEKIT_DIR_CONTACTS'},
    'accounts_contacts_mekit_acq': {title: 'LBL_ACCOUNTS_CONTACTS_MEKIT_ACQ_CONTACTS'},
    'accounts_contacts_mekit_adm': {title: 'LBL_ACCOUNTS_CONTACTS_MEKIT_ADM_CONTACTS'},
    'accounts_contacts_mekit_com': {title: 'LBL_ACCOUNTS_CONTACTS_MEKIT_COM_CONTACTS'},
    'accounts_contacts_mekit_opr': {title: 'LBL_ACCOUNTS_CONTACTS_MEKIT_OPR_CONTACTS'},
...
Beans['Tasks'].SearchFields = ['status','date_due','assigned_user_name','priority'];
...
Beans['Project'].AdditionalFields = ['status','priority','tipo_c','assigned_user_name','estimated_start_date','estimated_end_date','area_dinteresse_imp_c','analisi_realta_c','aggiornamenti_c','conclusioni_c','fineeffettiva_c','description','created_by_name'];
...
Beans['Cases'].AdditionalFields = ['account_name','jjwg_maps_address_c','descrizione_problematica_c','ref_part_number_c','ref_part_description_c','ref_part_unique_number_c','description','descrizione_aggiornamento_c','date_close_efct_c','state','status','case_number','priority','type','internal_tag_number_c','imp_ras_number_c','rif_commessa_code_c','date_entered','date_close_prg_c','assigned_user_name'];
Beans['Cases'].SearchFields = ['type','date_close_prg_c','state','status','priority','descrizione_problematica_c','account_name','area_dinteresse_imp_c','date_close_efct_c','origine_c','resolution','assigned_user_name'];
Beans['Cases'].CustomListFields = ['account_name','state','status'];
