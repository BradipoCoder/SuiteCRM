...
Beans['Accounts'].AdditionalFields = ['phone_office','phone_fax','website','email1','description','vat_number_c','codice_fiscale_c','$ADDbilling','$ADDshipping','imp_agent_code_c','industry','imp_status_c','imp_status_phase__c','imp_profitability_c','imp_client_yearly_revenue_c','imp_interest_articles_c','employee_number_c','imp_competitor_c','imp_other_competitor_c','imp_sync_as_client_c','imp_sync_as_supplier_c'];
