...
class AccountFixer
{
  ...
  public function __construct($logger)
  {
    ...
    //$this->log("M30: " . $this->currentDateMinus30D->format("Y-m-d"));
    if ($this->dryRun){
      $this->log(str_repeat("#", 120));
      $this->log("RUNNING IN DRY MODE! NO UPDATES WILL BE EXECUTED.");
      $this->log(str_repeat("#", 120));
    }
  }
  ...
  {
    $this->log(str_repeat("-", 60) . ": Cliente/Attivo -> Cliente/Fidelizzato (se acquistato 9 su 12 mesi recenti)");
