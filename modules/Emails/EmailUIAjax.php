...
if (isset($_REQUEST['emailUIAction'])) {
  switch ($_REQUEST['emailUIAction']) {
    ...
    case "doAssignmentDelete";
      ...
      if (isset($_REQUEST['uids']) && !empty($_REQUEST['uids']) && isset($_REQUEST['ieId']) && !empty($_REQUEST['ieId'])
    ...
    case "markEmail":
      ...
      if (isset($_REQUEST['uids']) && !empty($_REQUEST['uids']) && isset($_REQUEST['type']) && !empty($_REQUEST['type'])
          && isset($_REQUEST['folder'])
          && !empty($_REQUEST['folder'])
          && isset($_REQUEST['ieId'])
          && (!empty($_REQUEST['ieId'])
    ...
    case "getMessageListSugarFolders":
      ...
      if (isset($_REQUEST['ieId']) && !empty($_REQUEST['ieId'])) {
        ...
        if (!empty($sortSerial) && !empty($_REQUEST['ieId']) && !empty($_REQUEST['mbox'])) {
          ...
          $GLOBALS['log']->debug(
            "********** EMAIL 2.0********** ary=" . print_r($sortArray, TRUE) . ' id=' . $_REQUEST['ieId'] . '; box='
            . $_REQUEST['mbox']
          );
